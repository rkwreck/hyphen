  ...
  return (
    <div className="fixed inset-0 z-50 flex" onClick={onClose}>
      <div
        ...
        style={{ borderRight: '1px solid var(--pink-100)' }}
        onClick={e => e.stopPropagation()}
      >
        <div className="flex items-center justify-between mb-5">
          <h2 className="font-semibold" style={{ color: 'var(--pink-700)' }}>Menu</h2>
        ...
        {(['expiry', 'store'] as const).map(s => (
          <button
            ...
            style={{
              background: currentSort === s ? 'var(--pink-100)' : 'transparent',
              color: currentSort === s ? 'var(--pink-700)' : '#374151',
